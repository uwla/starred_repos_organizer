...
function topicToCheckbox(t: Topic) {
    return { topic: t, checked: true } as TopicCheckbox
}
...
function TopicSelect(props: Props) {
    ...
    const handleSubmit = () => {
        ...
        if (tab === "allowed_list") {
            const newAllowedList = allowedList
                .split("\n")
                .map(str => str.trim())
                .filter(str => str !== "")
        ...
        >
            ...
            <Modal.Body>
                <Nav
                    ...
                    className="mb-3"
                >
                    <Nav.Item onClick={() => setTab("edit")}>
                        <Nav.Link eventKey="edit">MANUAL EDIT</Nav.Link>
                    </Nav.Item>
                    <Nav.Item onClick={() => setTab("allowed_list")}>
                        <Nav.Link eventKey="allowed_list">
                            ALLOWED LIST
                        </Nav.Link>
                    </Nav.Item>
                    <Nav.Item onClick={() => setTab("alias_list")}>
                        <Nav.Link eventKey="alias_list">ALIAS LIST</Nav.Link>
                    </Nav.Item>
                </Nav>
                {tab === "edit" && (
                    <>
                        <p>
                            Uncheck topics to delete them. Checked topics will
                            remain.
                        </p>
                        <div className="mb-3">
                            <Form.Control
                ...
                {tab === "allowed_list" && (
                    <div id="allowed-topics">
                        <p>
                            Topics <b>not</b> in this allowed-topics list are{" "}
                            <b>deleted</b>.
                        </p>
                        <p>
                            Empty list means <b>all</b> topics are{" "}
                            <b>allowed</b>.
                        </p>
                        <p>
                            Insert <b>one topic per line</b>.
                        </p>
                        <Form.Control
                            as="textarea"
                            rows={10}
                ...
                {tab === "alias_list" && (
                    <div id="alias-list">
                        <p>
                            To avoid duplicated topics you can set aliases to be
                            converted to a main topic. Example:
                        </p>
                        <code className="my-2 py-2 d-block">
                            cli command-line commandline command-line-tool
                            cli-tool
                        </code>
                        <p>
